      ...
      <article className="mb-7 grid grid-cols-2 flex-row gap-10">
        <div className="ml-5 flex flex-col justify-evenly lg:m-0 lg:!flex-row">
          <div className="flex flex-col gap-y-4">
            ...
            <p className="flex items-end text-xs leading-5 lg:col-span-4 lg:text-lg">
          ...
          <div>
            <h1 className="mt-4 text-lg font-bold lg:mt-10 lg:text-3xl">Site&nbsp;Links</h1>
            <div className="text-sm leading-6 lg:mt-10	lg:text-lg">
              <h3>Home</h3>
              <h3>About us</h3>
              <h3>Recent Work</h3>
            </div>
        ...
        <div className="flex flex-col lg:gap-y-10 lg:leading-7">
          <div className="flex items-center justify-between lg:mt-10">
            ...
            <h1 className="-mt-2 mb-4 text-lg font-bold lg:text-3xl">Services</h1>
            <span className="hidden h-0.5 w-52 bg-white lg:flex" />
          </div>
          <div className="lg:grid lg:grid-cols-3 lg:gap-x-10">
            {services.map((service, index) => (
              <h3 key={index} className="text-sm leading-6">
                {service}
              </h3>
            ))}
          </div>
