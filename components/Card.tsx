...
export const CardTitle: FCC = ({ children }) => {
  return (
    <h4 className="mt-4 mb-3 text-center text-card-title capitalize text-primary">{children}</h4>
  );
};

export const CardDescription: FCC = ({ children }) => {
  return (
    <p className="max-w-[250px] text-center text-card-description text-description">{children}</p>
  );
};
...
export const ServicesCard: FCC<ServicesCardProps> = ({ description, image, title }) => {
  return (
    <Card className="flex min-w-fit flex-col items-center justify-center bg-white px-14 pt-10 pb-14">
